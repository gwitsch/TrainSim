...
/**
 * Represents a wagon for transporting passengers.
 * 
...
public class PassengerCar extends Wagon {
	 ...
	 */
	public PassengerCar(Weight emptyWeight, Length length, long maxPassengers, Weight maxAdditionalLoad, Classification classification,
